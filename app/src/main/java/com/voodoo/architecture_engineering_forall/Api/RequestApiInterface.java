package com.voodoo.architecture_engineering_forall.Api;

import com.voodoo.architecture_engineering_forall.AirForecast;
import com.voodoo.architecture_engineering_forall.EnvProportion;
import com.voodoo.architecture_engineering_forall.LoginBean;
import com.voodoo.code_architecture.request.data.BaseResponse;
import com.voodoo.code_architecture.request.data.bean.GirlsBean;
import com.voodoo.code_architecture.request.data.entity.HttpResult;
import com.voodoo.code_architecture.request.data.pojo.GankResp;
import com.voodoo.code_architecture.request.data.pojo.IpResult;
import com.voodoo.code_architecture.request.data.pojo.MovieSubject;
import com.voodoo.code_architecture.request.data.pojo.User;
import com.voodoo.code_architecture.request.data.pojo.WrapperRspEntity;
import com.voodoo.code_architecture.request.data.response.BookSearchResponse;
import com.voodoo.code_architecture.request.data.response.NotLoginResponse;
import com.voodoo.code_architecture.request.data.response.myinterface.MyResponse;
